-- Ajouter les contraintes manquantes et peupler les données

-- Ajouter la contrainte unique nécessaire pour user_engagement_metrics
...
-- Créer le trigger sur activity_logs (s'il n'existe pas déjà)
...
-- Créer une fonction pour recalculer les métriques manuellement
