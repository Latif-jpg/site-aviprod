-- Migration simple pour peupler les données - approche directe
...
-- Peupler les métriques d'engagement avec une approche simplifiée
...
-- Créer les fonctions de calcul des métriques
